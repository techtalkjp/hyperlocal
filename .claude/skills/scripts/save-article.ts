...
async function main() {
  ...
  if (values.stdin) {
    ...
    console.error("\nUsage:");
    console.error(
      '  echo \'{"title":"...","description":"...","content":"..."}\' | npx tsx save-article.ts --area asakusa --scene morning-cafe --stdin',
    );
  ...
  console.log(`pnpm --filter @hyperlocal/admin generate:article --file ${filepath}`);
}
