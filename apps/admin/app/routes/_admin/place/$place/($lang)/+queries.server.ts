...
export const getPlace = async (env: AdminEnv, placeId: string): Promise<Place | undefined> => {
...
export const getLocalizedPlace = async (env: AdminEnv, placeId: string, lang: string) => {
