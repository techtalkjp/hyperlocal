...
import { generateCanonicalLink, generateCanonicalUrl } from "~/features/seo/canonical-url";
...
export const loader = async ({ request, params }: Route.LoaderArgs) => {
  const { city, lang, area, category, rankingType } = getPathParams(request, params, {
