...
export const meta: Route.MetaFunction = ({ loaderData, location }) => {
  ...
  const rating =
    loaderData?.place.rating != null ? Number(loaderData.place.rating).toFixed(2) : null;
...
export const loader = async ({ request, params }: Route.LoaderArgs) => {
  ...
  const place =
    ((await readShard(`place/${lang.id}/${placeId}.json`)) as unknown as LocalizedPlace | null) ??
