...
describe("getPathParams", () => {
  const createRequest = (path: string) => new Request(`http://tokyo.example.com${path}`);
  ...
  describe("category parameter tests", () => {
    ...
    it("should return undefined when invalid category specified and not required", () => {
      const result = getPathParams(createRequest("/area/shibuya/invalid-category"), {
        area: "shibuya",
  ...
  describe("rank parameter tests", () => {
    it("should return ranking type when valid", () => {
      const result = getPathParams(createRequest("/area/shibuya/lunch/review"), {
        area: "shibuya",
        category: "lunch",
        rank: "review",
      });
    ...
    it("should return undefined when invalid ranking type specified and not required", () => {
      const result = getPathParams(createRequest("/area/shibuya/lunch/invalid-rank"), {
        area: "shibuya",
        category: "lunch",
        rank: "invalid-rank",
      });
