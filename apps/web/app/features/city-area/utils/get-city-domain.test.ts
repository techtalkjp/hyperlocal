...
describe("getCityDomain", () => {
  const testCases: Array<{
    ...
    {
      description: "should remove city from hyper-local.app when cityId is undefined",
    ...
    {
      description: "should remove city from regular domain when cityId is undefined",
      input: { url: "https://tokyo.hostname.com/" },
      expected: "https://hostname.com/",
    },
    {
      description: "should preserve path and query parameters for special domain",
      input: {
        url: "https://tokyo.hyper-local.app/path?param1=value1&param2=value2",
        cityId: "osaka",
      },
      expected: "https://osaka.hyper-local.app/path?param1=value1&param2=value2",
    },
    {
      description: "should preserve path, query parameters, and fragment for regular domain",
      input: {
