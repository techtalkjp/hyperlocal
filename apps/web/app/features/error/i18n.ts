...
const errorMessagesEn: ErrorMessageMap = {
  ...
  "server-error": {
    title: "Server Error",
    description: "A temporary server error has occurred. Please wait a moment and try again.",
    action: "Retry",
  },
  "not-found": {
...
const errorMessagesJa: ErrorMessageMap = {
  "network-error": {
    title: "接続エラー",
    description: "サーバーに接続できません。インターネット接続を確認して、もう一度お試しください。",
    action: "再試行",
  },
  "server-error": {
    title: "サーバーエラー",
    description: "サーバーで一時的なエラーが発生しました。しばらく待ってから再度お試しください。",
    action: "再試行",
  },
  "not-found": {
    title: "ページが見つかりません",
...
const errorMessagesKo: ErrorMessageMap = {
  "network-error": {
    title: "연결 오류",
    description: "서버에 연결할 수 없습니다. 인터넷 연결을 확인하고 다시 시도해 주세요.",
    action: "재시도",
  },
  "server-error": {
    title: "서버 오류",
